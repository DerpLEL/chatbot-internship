...
"""
    ...
    def __init__(self):
        ...
        self.drink_chain = load_qa_with_sources_chain(llm=self.llm3, chain_type="stuff",
        ...
        self.leave_application_chain = LLMChain(llm=self.llm2,
                                                prompt=PromptTemplate.from_template(self.classifier_leave_application))
        self.delete_chat_chain = LLMChain(llm=self.llm2,
                                          prompt=PromptTemplate.from_template(self.delete_custom_template))
    ...
    def chat_hrm(self, query, email):
        ...
        if label_hrm == "User":
            ...
            if self.get_conversation_type(email) == ['', ''] or self.get_conversation_type(email) == [
                'LeaveApplication', '']:
...
VALUES ('{email}', NULL, NULL, NULL, NULL, NULL, NULL, NULL);""")
    ...
    def chat_private(self, query, email, name):
        ...
        if label == "drink fee":
            ...
            input_pandas = self.drink_chain({'input_documents': doc, 'question': query, 'context': ''},
                                            return_only_outputs=False)
            ...
            try:
                ...
                return {
                    'output_text': 'Không tìm thấy file tiền nước, bạn vui lòng hỏi lại với đầy đủ thông tin.'}, None
